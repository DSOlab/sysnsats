...
int main(int argc, char *argv[]) {
  ...
  /* Test 1: Testing attitude stream with normal dates. No errors */
  {
    try {
      ...
      att = new MeasuredAttitude(SATELLITE::JASON2, argv[1]);
    ...
    auto t = MjdEpoch(55196, FractionalSeconds(13.123));
  ...
  /* Test 2: Go (way) backwards in time; should fail */
  {
    try {
      /* get the measured attitude stream for the satellite */
      att = new MeasuredAttitude(SATELLITE::JASON2, argv[1],
                                 MjdEpoch(55196, FractionalSeconds(13.123)));
    ...
    auto t = MjdEpoch(55191, FractionalSeconds(13.123));
  ...
  {
    /* the last record included in the file: 55200 2.763137662529e+04 */
    try {
      /* get the measured attitude stream for the satellite */
      att = new MeasuredAttitude(
          SATELLITE::JASON2, argv[1],
          MjdEpoch(55200, FractionalSeconds(2.763137662529e+04 - 200e0)));
    ...
    auto t = MjdEpoch(55200, FractionalSeconds(2.763137662529e+04 + 2e0));
