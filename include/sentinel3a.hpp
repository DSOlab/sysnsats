...
/* @file
 *
 * Sentinel-3A Macromodel according to:
 ...
 *
 * Sentinel-3A has one solar panel (properties described in the macromodel).
...
template <> struct SatelliteMacromodelTraits<SATELLITE::SENTINEL3A> {
  ...
  static constexpr std::array<MacromodelSurfaceElement, 8> model = {{
      ...
      {5.40e0, 0.e0, 0.e0, -1.e0, 0.351e0, 0.615e0, 0.034e0, 0.139e0, 0.575e0,
       0.246},
      /* solar array */
      {10.5e0, 1.e0, 0.e0, 0.e0, 0.202e0, 0.060e0, 0.738e0, 0.310e0, 0.069e0,
       0.621},
  ...
  static constexpr double srp_cannonball_area() { return 10.5 + 4.68; };
   ...
   *
   * For the case of Sentinel-3A, we need one quaternion, to rotate all
