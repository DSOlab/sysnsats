...
{
  template <>
  struct SatelliteMacromodel<SATELLITE::JASON2> : public satellite_details::BaseMacromodel
  {

    static constexpr std::array<MacromodelSurfaceElement, 8> model = {{{0.783e0,
                                                                        {-1e0, 0e0, 0e0},
