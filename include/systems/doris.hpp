...
{
  template <>
  struct SatelliteSystemTraits<SATELLITE_SYSTEM::DORIS>
  {
  ...
  template <>
  struct SatelliteSystemObservationType<SATELLITE_SYSTEM::DORIS>
  {
     ...
     *        ObservationType.
     */
    char obst2char(ObservationType obs);
     ...
     */
    ObservationType char2obst(char c);
